...
During job interviews when people ask me what my biggest weakness is I tell them about my shiny objects disorder(SOD). I could be deep into something and suddenly find myself veering way off course.

There I was studiously plugging along with React/Gatsby when I came across Frontmasters [SVG Essentials class](https://frontendmasters.com/courses/svg-essentials-animation/). Sarah Drasner, the instructor, gives a solid overview about what is so freakin' amazing about SVG animations. She has a fabulous [codepen](https://codepen.io/sdras) collection of SVG animations you should check out for inspiration. Here is one where she explains [how the GSAP timeline works](https://codepen.io/sdras/pen/ByEWON).
