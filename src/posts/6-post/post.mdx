...
I wanted to add in a skip link at the top of each page. If, every time you go to a new page, you'd have to [tab through the banner ad and all the navigation](https://www.schoolhouse.com/) just to get to the main content you'd appreciate the [skip link](https://webaim.org/techniques/skipnav/). I wanted mine to be visible. I also wanted people to be able to toggle a larger font and a dark mode so I added in an accessibility toolbar using icons at the top left with the skip link following the logo.
...
to the difference in altering clothing and making an entirely new piece from a pattern. Making a new piece is so much cleaner and easier.
