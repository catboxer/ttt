...
<article>
        <h1>About</h1>
        <h2>Purpose</h2>
        <p>There is a treasure trove of shared knowledge on the Internet. I feel such awe everytime I reach out to solve a problem and someone hands me a guide to the solution. The biggest high I get is when I've been struggling --could be for hours-- and I read somone's words that blows open a door into a whole new world. </p>
        <p>I created this blog as a repository of educational materials I found most helpful while teaching myself Front End Development. Because I am not using many of the tools everyday I found myself spending a lot more time searching for that one article or video I had watched a month ago instead of reviewing the concept. 
        Here you will find the articles and videos that I found useful plus examples of current projects and challenges.</p>
        
        <p>The resources I lean towards tend to use everyday language --'simple' cause I'm definintely not the brightest bulb out there-- to coherently explain complex concepts.</p> <p>My interest is piqued by headless CMS and a JAMstack setup --because backend ugh!--. Some of my current topics include Vanilla Javascript, Gatsby, GraphQL, RESTAPIs, CSS, HTML, Accessibilty, SGV animation. </p>
        <p>On my sidebar you will see a couple of tweets from my <a href="https://twitter.com/i/lists/1351205591126048770" target="_blank" rel="noopener noreferrer">Twitter List</a> of any person that posted or wrote or made something I learned from.</p>
        ...
        <p><Link to="/contact">Contact me</Link> if you have a link you've found invaluable and would like to share.</p>
        <h2>Background</h2>
